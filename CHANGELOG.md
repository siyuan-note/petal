...
* [Add current workspace storage statistics API declarations](https://github.com/siyuan-note/siyuan/issues/19790)
...
* [Extend input dialog options with labels, descriptions, extra controls, and custom actions](https://github.com/siyuan-note/siyuan/issues/19420)
* [Add generated kernel API contracts and typed fetch helpers, including transaction, streaming, and raw response declarations](https://github.com/siyuan-note/siyuan/issues/19378)
* [Support multiple shortcut bindings and command availability predicates](https://github.com/siyuan-note/siyuan/issues/19136)
* [Add plugin data change reason declarations](https://github.com/siyuan-note/siyuan/issues/19132)
* [Add custom top bar element declarations](https://github.com/siyuan-note/siyuan/issues/19330)
* [Add the top bar context menu callback and document its lifecycle](https://github.com/siyuan-note/siyuan/issues/19305)
...
* [Add global backlink and anchor sorting declarations](https://github.com/siyuan-note/siyuan/issues/19579)
* [Add block reference swap transaction declarations](https://github.com/siyuan-note/siyuan/issues/19485)
* [Add the block reference check setting declaration](https://github.com/siyuan-note/siyuan/issues/19134)
* [Update grouped search subtype declarations](https://github.com/siyuan-note/siyuan/issues/19395)
* [Add custom block search declarations](https://github.com/siyuan-note/siyuan/issues/19508)
* [Add asset reference and batch query API declarations with unavailable database diagnostics](https://github.com/siyuan-note/siyuan/issues/19468)
* [Add image viewer clipboard and file copy declarations and correct callback types](https://github.com/siyuan-note/siyuan/issues/19151)
* [Add image preview magnifier and navigation declarations](https://github.com/siyuan-note/siyuan/issues/19407)
* [Add the asset download mode configuration declaration](https://github.com/siyuan-note/siyuan/issues/19149)
* [Add the global default font configuration declaration](https://github.com/siyuan-note/siyuan/issues/19148)
* [Add the workspace background gradient configuration declaration](https://github.com/siyuan-note/siyuan/issues/19327)
* [Add the incomplete selection notification preference declaration](https://github.com/siyuan-note/siyuan/issues/19452)
* [Add AI provider custom request header declarations](https://github.com/siyuan-note/siyuan/issues/19219)
* [Add Anthropic Messages API declarations](https://github.com/siyuan-note/siyuan/issues/17845)
* [Add agent skill management APIs and skill file read-only reason declarations](https://github.com/siyuan-note/siyuan/issues/19227)
* [Add TypeSafe System One (Jev) decision model configuration and test API declarations](https://github.com/siyuan-note/siyuan/issues/19684)
